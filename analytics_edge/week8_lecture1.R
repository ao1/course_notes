...
# In this script file, we show how the airline revenue management problems 
# discussed in this lecture can be solved in R using the "lpSolveAPI" package. 
# This package allows you to solve linear optimization problems in R using the 
# lp_solve library, which is an open-sourced optimization solver. 

# If you are solving larger and more complex optimization problems, lp_solve 
# might not be powerful enough to solve your problems. There are other 
# optimization packages available in R that rely on commercial solvers, 
# such as cplexAPI and Rcplex. For more information, see the 
# CRAN Optimization page: http://cran.us.r-project.org/web/views/Optimization.html
...
# decision variables: the number of regular seats to offer, 
# and the number of discount seats to offer. 
...
# viewing the constraints in a matrix format. Our objective 
# and three constraints are as follows:
...
# second column in our constraint matrix is c(1,0,1). We also need 
# to indicate that these are less-than-or-equal constraints, and set 
# the right-hand-side values to c(166,100,150):
...
# we will learn about integer and binary decision variables - 
# to change a decision variable to one of these types, 
# you can use the set.type function.)
